...
Page({
  ...
  editAlbum: function () {
    wx.navigateTo({
      url: `/pages/album/create/create?id=${this.data.album._id || this.data.album.id}`
    })
  },
  ...
  viewPhoto: function (e) {
    ...
    const photo = this.data.photos.find(p => (p._id === photoId) || (p.id === photoId))
  ...
  onShareAppMessage: function () {
    return {
      ...
      path: `/pages/album/detail/detail?id=${this.data.album._id || this.data.album.id}`,
